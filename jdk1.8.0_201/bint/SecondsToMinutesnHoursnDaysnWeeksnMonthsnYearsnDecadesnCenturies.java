...
class SecondsToMinutesnHoursnDaysnWeeksnMonthsnYearsnDecadesnCenturies
{
 public static void main(String[]args)
 {
  ...
  System.out.println((S)+ " = "+ (S/60/60/24/30/365/10)+ " Decade/s");
  System.out.println((S)+ " = "+ (S/60/60/24/30/365/100)+ " Century/ies");
  }
}